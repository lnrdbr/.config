...
import {
  initiate
} from "./chunk-22IR5OXB.js";
import "./chunk-JQVTPWDP.js";
import "./chunk-VACF7JKQ.js";
import {
  __commonJS,
  __require,
  __toESM
...
createStorybookProgram.action(async (options) => {
  ...
  options.debug = options.debug ?? !1, options.dev = options.dev ?? isNeitherCiNorSandbox, options.features === !1 && (options.features = []), await initiate(options).catch(() => process.exit(1));
